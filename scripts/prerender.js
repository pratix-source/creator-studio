...
const metadata = { title: 'Free Video Content Creator Studio | Pratix.io', description: 'Create video scripts, clean text, estimate voice-over duration and prepare vertical teleprompter content in your browser.', route: '/en/creator-studio' };
